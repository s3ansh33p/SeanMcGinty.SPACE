...
<html lang="en">
  <head>
    ...
    <meta property="og:description"   content="Decay is cool" />
...
<body class="bgimg">
    <div class="content">
      ...
      <div class="middle">
        ...
        <h1 style="font-size:48px">Decay</h1>
        <p>Plays Garry's Mod, Arma III and osu!</p>
      </div>
      <ul class="social">
        <li><a href="mailto:carpenterl12@outlook.com"><i class="fa fa-envelope-square" aria-hidden="true"></i></a></li>
        <li><a target="_blank" href="https://github.com/Haxo24"><i class="fa fa-github-square" aria-hidden="true"></i></a></li>
        <li><a target="_blank" href="https://twitter.com/Haxo241"><i class="fa fa-twitter-square" aria-hidden="true"></i></a></li>
        ...
        <li><a target="_blank" href="https://steamcommunity.com/profiles/76561198207443543"><i class="fa fa-steam-square" aria-hidden="true"></i></a></li>
      </ul>
      <div class="siteref">
